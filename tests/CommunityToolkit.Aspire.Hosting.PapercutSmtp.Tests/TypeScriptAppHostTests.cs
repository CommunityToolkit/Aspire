...
public class TypeScriptAppHostTests
{
    ...
    public async Task TypeScriptAppHostCompilesAndStarts()
    {
        ...
        string appHostPath = Path.Combine(repoRoot, "examples", "papercut", "CommunityToolkit.Aspire.Hosting.PapercutSmtp.AppHost.TypeScript", "apphost.ts");
        string packageProjectPath = Path.Combine(repoRoot, "src", "CommunityToolkit.Aspire.Hosting.PapercutSmtp", "CommunityToolkit.Aspire.Hosting.PapercutSmtp.csproj");
