...
public class TypeScriptAppHostTests
{
    ...
    public async Task TypeScriptAppHostCompilesAndStarts()
    {
        ...
        string appHostPath = Path.Combine(repoRoot, "examples", "meilisearch", "CommunityToolkit.Aspire.Hosting.Meilisearch.AppHost.TypeScript", "apphost.ts");
        string packageProjectPath = Path.Combine(repoRoot, "src", "CommunityToolkit.Aspire.Hosting.Meilisearch", "CommunityToolkit.Aspire.Hosting.Meilisearch.csproj");
