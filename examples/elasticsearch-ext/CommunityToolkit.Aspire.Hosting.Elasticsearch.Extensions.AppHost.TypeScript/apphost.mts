...
async function validateWithHostPort(
    elasticvue: ElasticvueContainerResource,
): Promise<ElasticvueContainerResource> {
...
async function validateWithElasticvue(
    elasticsearch: ElasticsearchResource,
): Promise<ElasticsearchResource> {
