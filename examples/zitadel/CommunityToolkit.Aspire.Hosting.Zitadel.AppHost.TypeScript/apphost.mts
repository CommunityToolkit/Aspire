...
const username = await builder.addParameter("zitadel-username", {
    value: "admin",
});
const password = await builder.addParameter("zitadel-password", {
    value: "AspireZitadelPassword!1",
    secret: true,
});
const masterKey = await builder.addParameter("zitadel-master-key", {
    value: "Aa1!Aa1!Aa1!Aa1!Aa1!Aa1!Aa1!Aa1!",
    secret: true,
});
