...
/** Handle to GolangAppExecutableResource */
type GolangAppExecutableResourceHandle = Handle<'CommunityToolkit.Aspire.Hosting.Golang/Aspire.Hosting.ApplicationModel.GolangAppExecutableResource'>;
...
export interface AddGolangAppOptions {
    args?: string[];
    buildTags?: string[];
}
...
export interface WithGoModDownloadOptions {
    install?: boolean;
}

export interface WithGoModTidyOptions {
    install?: boolean;
}
...
export class DistributedApplicationBuilder {
    ...
    /** Adds a Golang app resource */
    /** @internal */
    async _addGolangAppInternal(name: string, workingDirectory: string, executable: string, args?: string[], buildTags?: string[]): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, workingDirectory, executable };
        if (args !== undefined) rpcArgs.args = args;
        if (buildTags !== undefined) rpcArgs.buildTags = buildTags;
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'CommunityToolkit.Aspire.Hosting.Golang/addGolangApp',
            rpcArgs
        );
        return new GolangAppExecutableResource(result, this._client);
    }

    addGolangApp(name: string, workingDirectory: string, executable: string, options?: AddGolangAppOptions): GolangAppExecutableResourcePromise {
        const args = options?.args;
        const buildTags = options?.buildTags;
        return new GolangAppExecutableResourcePromise(this._addGolangAppInternal(name, workingDirectory, executable, args, buildTags));
    }
...
export class DistributedApplicationBuilderPromise implements PromiseLike<DistributedApplicationBuilder> {
    ...
    /** Adds a Golang app resource */
    addGolangApp(name: string, workingDirectory: string, executable: string, options?: AddGolangAppOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.addGolangApp(name, workingDirectory, executable, options)));
    }
...
// ============================================================================
// GolangAppExecutableResource
// ============================================================================

export class GolangAppExecutableResource extends ResourceBuilderBase<GolangAppExecutableResourceHandle> {
    constructor(handle: GolangAppExecutableResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }

    /** @internal */
    private async _withContainerRegistryInternal(registry: ResourceBuilderBase): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, registry };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withContainerRegistry',
            rpcArgs
    ...
    /** Configures a resource to use a container registry */
    withContainerRegistry(registry: ResourceBuilderBase): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withContainerRegistryInternal(registry));
    }

    /** @internal */
    private async _withDockerfileBaseImageInternal(buildImage?: string, runtimeImage?: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (buildImage !== undefined) rpcArgs.buildImage = buildImage;
        if (runtimeImage !== undefined) rpcArgs.runtimeImage = runtimeImage;
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
    ...
    /** Sets the base image for a Dockerfile build */
    withDockerfileBaseImage(options?: WithDockerfileBaseImageOptions): GolangAppExecutableResourcePromise {
        const buildImage = options?.buildImage;
        const runtimeImage = options?.runtimeImage;
        return new GolangAppExecutableResourcePromise(this._withDockerfileBaseImageInternal(buildImage, runtimeImage));
    }

    /** @internal */
    private async _publishAsDockerFileInternal(): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/publishAsDockerFile',
            rpcArgs
    ...
    /** Publishes the executable as a Docker container */
    publishAsDockerFile(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._publishAsDockerFileInternal());
    }

    /** @internal */
    private async _publishAsDockerFileWithConfigureInternal(configure: (obj: ContainerResource) => Promise<void>): Promise<GolangAppExecutableResource> {
        const configureId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ContainerResourceHandle;
            const obj = new ContainerResource(objHandle, this._client);
            await configure(obj);
    ...
    /** Publishes an executable as a Docker file with optional container configuration */
    publishAsDockerFileWithConfigure(configure: (obj: ContainerResource) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._publishAsDockerFileWithConfigureInternal(configure));
    }

    /** @internal */
    private async _withExecutableCommandInternal(command: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, command };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withExecutableCommand',
            rpcArgs
    ...
    /** Sets the executable command */
    withExecutableCommand(command: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withExecutableCommandInternal(command));
    }

    /** @internal */
    private async _withWorkingDirectoryInternal(workingDirectory: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, workingDirectory };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withWorkingDirectory',
            rpcArgs
    ...
    /** Sets the executable working directory */
    withWorkingDirectory(workingDirectory: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withWorkingDirectoryInternal(workingDirectory));
    }

    /** @internal */
    private async _withMcpServerInternal(path?: string, endpointName?: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (path !== undefined) rpcArgs.path = path;
        if (endpointName !== undefined) rpcArgs.endpointName = endpointName;
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
    ...
    /** Configures an MCP server endpoint on the resource */
    withMcpServer(options?: WithMcpServerOptions): GolangAppExecutableResourcePromise {
        const path = options?.path;
        const endpointName = options?.endpointName;
        return new GolangAppExecutableResourcePromise(this._withMcpServerInternal(path, endpointName));
    }

    /** @internal */
    private async _withOtlpExporterInternal(): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withOtlpExporter',
            rpcArgs
    ...
    /** Configures OTLP telemetry export */
    withOtlpExporter(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withOtlpExporterInternal());
    }

    /** @internal */
    private async _withOtlpExporterProtocolInternal(protocol: OtlpProtocol): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, protocol };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withOtlpExporterProtocol',
            rpcArgs
    ...
    /** Configures OTLP telemetry export with specific protocol */
    withOtlpExporterProtocol(protocol: OtlpProtocol): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withOtlpExporterProtocolInternal(protocol));
    }

    /** @internal */
    private async _withRequiredCommandInternal(command: string, helpLink?: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, command };
        if (helpLink !== undefined) rpcArgs.helpLink = helpLink;
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withRequiredCommand',
    ...
    /** Adds a required command dependency */
    withRequiredCommand(command: string, options?: WithRequiredCommandOptions): GolangAppExecutableResourcePromise {
        const helpLink = options?.helpLink;
        return new GolangAppExecutableResourcePromise(this._withRequiredCommandInternal(command, helpLink));
    }

    /** @internal */
    private async _withEnvironmentCallbackInternal(callback: (arg: EnvironmentCallbackContext) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as EnvironmentCallbackContextHandle;
            const arg = new EnvironmentCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Sets environment variables via callback */
    withEnvironmentCallback(callback: (arg: EnvironmentCallbackContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withEnvironmentCallbackInternal(callback));
    }

    /** @internal */
    private async _withEnvironmentEndpointInternal(name: string, endpointReference: EndpointReference): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, endpointReference };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withEnvironmentEndpoint',
            rpcArgs
    ...
    /** Sets an environment variable from an endpoint reference */
    withEnvironmentEndpoint(name: string, endpointReference: EndpointReference): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withEnvironmentEndpointInternal(name, endpointReference));
    }

    /** @internal */
    private async _withEnvironmentInternal(name: string, value: string | ReferenceExpression | EndpointReference | ParameterResource | ResourceWithConnectionString): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withEnvironment',
            rpcArgs
    ...
    /** Sets an environment variable on the resource */
    withEnvironment(name: string, value: string | ReferenceExpression | EndpointReference | ParameterResource | ResourceWithConnectionString): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withEnvironmentInternal(name, value));
    }

    /** @internal */
    private async _withEnvironmentParameterInternal(name: string, parameter: ParameterResource): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, parameter };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withEnvironmentParameter',
            rpcArgs
    ...
    /** Sets an environment variable from a parameter resource */
    withEnvironmentParameter(name: string, parameter: ParameterResource): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withEnvironmentParameterInternal(name, parameter));
    }

    /** @internal */
    private async _withEnvironmentConnectionStringInternal(envVarName: string, resource: ResourceBuilderBase): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, envVarName, resource };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withEnvironmentConnectionString',
            rpcArgs
    ...
    /** Sets an environment variable from a connection string resource */
    withEnvironmentConnectionString(envVarName: string, resource: ResourceBuilderBase): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withEnvironmentConnectionStringInternal(envVarName, resource));
    }

    /** @internal */
    private async _withArgsInternal(args: string[]): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, args };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withArgs',
            rpcArgs
    ...
    /** Adds arguments */
    withArgs(args: string[]): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withArgsInternal(args));
    }

    /** @internal */
    private async _withArgsCallbackInternal(callback: (obj: CommandLineArgsCallbackContext) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as CommandLineArgsCallbackContextHandle;
            const obj = new CommandLineArgsCallbackContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Sets command-line arguments via callback */
    withArgsCallback(callback: (obj: CommandLineArgsCallbackContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withArgsCallbackInternal(callback));
    }

    /** @internal */
    private async _withArgsCallbackAsyncInternal(callback: (arg: CommandLineArgsCallbackContext) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as CommandLineArgsCallbackContextHandle;
            const arg = new CommandLineArgsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Sets command-line arguments via async callback */
    withArgsCallbackAsync(callback: (arg: CommandLineArgsCallbackContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withArgsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withReferenceInternal(source: ResourceBuilderBase, connectionName?: string, optional?: boolean, name?: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, source };
        if (connectionName !== undefined) rpcArgs.connectionName = connectionName;
        if (optional !== undefined) rpcArgs.optional = optional;
        if (name !== undefined) rpcArgs.name = name;
    ...
    /** Adds a reference to another resource */
    withReference(source: ResourceBuilderBase, options?: WithReferenceOptions): GolangAppExecutableResourcePromise {
        const connectionName = options?.connectionName;
        const optional = options?.optional;
        const name = options?.name;
        return new GolangAppExecutableResourcePromise(this._withReferenceInternal(source, connectionName, optional, name));
    }

    /** @internal */
    private async _withReferenceUriInternal(name: string, uri: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, uri };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withReferenceUri',
            rpcArgs
    ...
    /** Adds a reference to a URI */
    withReferenceUri(name: string, uri: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withReferenceUriInternal(name, uri));
    }

    /** @internal */
    private async _withReferenceExternalServiceInternal(externalService: ExternalServiceResource): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, externalService };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withReferenceExternalService',
            rpcArgs
    ...
    /** Adds a reference to an external service */
    withReferenceExternalService(externalService: ExternalServiceResource): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withReferenceExternalServiceInternal(externalService));
    }

    /** @internal */
    private async _withReferenceEndpointInternal(endpointReference: EndpointReference): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, endpointReference };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withReferenceEndpoint',
            rpcArgs
    ...
    /** Adds a reference to an endpoint */
    withReferenceEndpoint(endpointReference: EndpointReference): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withReferenceEndpointInternal(endpointReference));
    }

    /** @internal */
    private async _withEndpointInternal(port?: number, targetPort?: number, scheme?: string, name?: string, env?: string, isProxied?: boolean, isExternal?: boolean, protocol?: ProtocolType): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (scheme !== undefined) rpcArgs.scheme = scheme;
    ...
    /** Adds a network endpoint */
    withEndpoint(options?: WithEndpointOptions): GolangAppExecutableResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const scheme = options?.scheme;
        const name = options?.name;
        ...
        const isExternal = options?.isExternal;
        const protocol = options?.protocol;
        return new GolangAppExecutableResourcePromise(this._withEndpointInternal(port, targetPort, scheme, name, env, isProxied, isExternal, protocol));
    }

    /** @internal */
    private async _withHttpEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    /** Adds an HTTP endpoint */
    withHttpEndpoint(options?: WithHttpEndpointOptions): GolangAppExecutableResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const name = options?.name;
        const env = options?.env;
        const isProxied = options?.isProxied;
        return new GolangAppExecutableResourcePromise(this._withHttpEndpointInternal(port, targetPort, name, env, isProxied));
    }

    /** @internal */
    private async _withHttpsEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    /** Adds an HTTPS endpoint */
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): GolangAppExecutableResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const name = options?.name;
        const env = options?.env;
        const isProxied = options?.isProxied;
        return new GolangAppExecutableResourcePromise(this._withHttpsEndpointInternal(port, targetPort, name, env, isProxied));
    }

    /** @internal */
    private async _withExternalHttpEndpointsInternal(): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withExternalHttpEndpoints',
            rpcArgs
    ...
    /** Makes HTTP endpoints externally accessible */
    withExternalHttpEndpoints(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withExternalHttpEndpointsInternal());
    }
    ...
    /** @internal */
    private async _asHttp2ServiceInternal(): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/asHttp2Service',
            rpcArgs
    ...
    /** Configures resource for HTTP/2 */
    asHttp2Service(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._asHttp2ServiceInternal());
    }

    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ResourceUrlsCallbackContextHandle;
            const obj = new ResourceUrlsCallbackContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceUrlsCallbackContextHandle;
            const arg = new ResourceUrlsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withUrl',
    ...
    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): GolangAppExecutableResourcePromise {
        const displayText = options?.displayText;
        return new GolangAppExecutableResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withUrlExpression',
    ...
    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): GolangAppExecutableResourcePromise {
        const displayText = options?.displayText;
        return new GolangAppExecutableResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const obj = wrapIfHandle(objData) as ResourceUrlAnnotation;
            await callback(obj);
        });
    ...
    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _withUrlForEndpointFactoryInternal(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as EndpointReferenceHandle;
            const arg = new EndpointReference(argHandle, this._client);
            return await callback(arg);
    ...
    /** Adds a URL for a specific endpoint via factory callback */
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withUrlForEndpointFactoryInternal(endpointName, callback));
    }

    /** @internal */
    private async _publishWithContainerFilesInternal(source: ResourceBuilderBase, destinationPath: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, source, destinationPath };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/publishWithContainerFilesFromResource',
            rpcArgs
    ...
    /** Configures the resource to copy container files from the specified source during publishing */
    publishWithContainerFiles(source: ResourceBuilderBase, destinationPath: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._publishWithContainerFilesInternal(source, destinationPath));
    }

    /** @internal */
    private async _excludeFromManifestInternal(): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/excludeFromManifest',
            rpcArgs
    ...
    /** Excludes the resource from the deployment manifest */
    excludeFromManifest(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._excludeFromManifestInternal());
    }

    /** @internal */
    private async _waitForInternal(dependency: ResourceBuilderBase): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, dependency };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/waitForResource',
            rpcArgs
    ...
    /** Waits for another resource to be ready */
    waitFor(dependency: ResourceBuilderBase): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._waitForInternal(dependency));
    }

    /** @internal */
    private async _waitForWithBehaviorInternal(dependency: ResourceBuilderBase, waitBehavior: WaitBehavior): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, dependency, waitBehavior };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/waitForWithBehavior',
            rpcArgs
    ...
    /** Waits for another resource with specific behavior */
    waitForWithBehavior(dependency: ResourceBuilderBase, waitBehavior: WaitBehavior): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._waitForWithBehaviorInternal(dependency, waitBehavior));
    }

    /** @internal */
    private async _waitForStartInternal(dependency: ResourceBuilderBase): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, dependency };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/waitForResourceStart',
            rpcArgs
    ...
    /** Waits for another resource to start */
    waitForStart(dependency: ResourceBuilderBase): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._waitForStartInternal(dependency));
    }

    /** @internal */
    private async _waitForStartWithBehaviorInternal(dependency: ResourceBuilderBase, waitBehavior: WaitBehavior): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, dependency, waitBehavior };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/waitForStartWithBehavior',
            rpcArgs
    ...
    /** Waits for another resource to start with specific behavior */
    waitForStartWithBehavior(dependency: ResourceBuilderBase, waitBehavior: WaitBehavior): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._waitForStartWithBehaviorInternal(dependency, waitBehavior));
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withExplicitStart',
            rpcArgs
    ...
    /** Prevents resource from starting automatically */
    withExplicitStart(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _waitForCompletionInternal(dependency: ResourceBuilderBase, exitCode?: number): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, dependency };
        if (exitCode !== undefined) rpcArgs.exitCode = exitCode;
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/waitForResourceCompletion',
    ...
    /** Waits for resource completion */
    waitForCompletion(dependency: ResourceBuilderBase, options?: WaitForCompletionOptions): GolangAppExecutableResourcePromise {
        const exitCode = options?.exitCode;
        return new GolangAppExecutableResourcePromise(this._waitForCompletionInternal(dependency, exitCode));
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, key };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withHealthCheck',
            rpcArgs
    ...
    /** Adds a health check by key */
    withHealthCheck(key: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withHttpHealthCheckInternal(path?: string, statusCode?: number, endpointName?: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (path !== undefined) rpcArgs.path = path;
        if (statusCode !== undefined) rpcArgs.statusCode = statusCode;
        if (endpointName !== undefined) rpcArgs.endpointName = endpointName;
    ...
    /** Adds an HTTP health check */
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): GolangAppExecutableResourcePromise {
        const path = options?.path;
        const statusCode = options?.statusCode;
        const endpointName = options?.endpointName;
        return new GolangAppExecutableResourcePromise(this._withHttpHealthCheckInternal(path, statusCode, endpointName));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<GolangAppExecutableResource> {
        const executeCommandId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ExecuteCommandContextHandle;
            const arg = new ExecuteCommandContext(argHandle, this._client);
            return await executeCommand(arg);
    ...
    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): GolangAppExecutableResourcePromise {
        const commandOptions = options?.commandOptions;
        return new GolangAppExecutableResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withDeveloperCertificateTrustInternal(trust: boolean): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, trust };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withDeveloperCertificateTrust',
            rpcArgs
    ...
    /** Configures developer certificate trust */
    withDeveloperCertificateTrust(trust: boolean): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withDeveloperCertificateTrustInternal(trust));
    }

    /** @internal */
    private async _withCertificateTrustScopeInternal(scope: CertificateTrustScope): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, scope };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withCertificateTrustScope',
            rpcArgs
    ...
    /** Sets the certificate trust scope */
    withCertificateTrustScope(scope: CertificateTrustScope): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withCertificateTrustScopeInternal(scope));
    }

    /** @internal */
    private async _withHttpsDeveloperCertificateInternal(password?: ParameterResource): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (password !== undefined) rpcArgs.password = password;
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withParameterHttpsDeveloperCertificate',
    ...
    /** Configures HTTPS with a developer certificate */
    withHttpsDeveloperCertificate(options?: WithHttpsDeveloperCertificateOptions): GolangAppExecutableResourcePromise {
        const password = options?.password;
        return new GolangAppExecutableResourcePromise(this._withHttpsDeveloperCertificateInternal(password));
    }

    /** @internal */
    private async _withoutHttpsCertificateInternal(): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withoutHttpsCertificate',
            rpcArgs
    ...
    /** Removes HTTPS certificate configuration */
    withoutHttpsCertificate(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withoutHttpsCertificateInternal());
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, parent };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withBuilderParentRelationship',
            rpcArgs
    ...
    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withParentRelationshipInternal(parent));
    }

    /** @internal */
    private async _withChildRelationshipInternal(child: ResourceBuilderBase): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, child };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withBuilderChildRelationship',
            rpcArgs
    ...
    /** Sets a child relationship */
    withChildRelationship(child: ResourceBuilderBase): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withChildRelationshipInternal(child));
    }

    /** @internal */
    private async _withIconNameInternal(iconName: string, iconVariant?: IconVariant): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, iconName };
        if (iconVariant !== undefined) rpcArgs.iconVariant = iconVariant;
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withIconName',
    ...
    /** Sets the icon for the resource */
    withIconName(iconName: string, options?: WithIconNameOptions): GolangAppExecutableResourcePromise {
        const iconVariant = options?.iconVariant;
        return new GolangAppExecutableResourcePromise(this._withIconNameInternal(iconName, iconVariant));
    }

    /** @internal */
    private async _withHttpProbeInternal(probeType: ProbeType, path?: string, initialDelaySeconds?: number, periodSeconds?: number, timeoutSeconds?: number, failureThreshold?: number, successThreshold?: number, endpointName?: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, probeType };
        if (path !== undefined) rpcArgs.path = path;
        if (initialDelaySeconds !== undefined) rpcArgs.initialDelaySeconds = initialDelaySeconds;
        if (periodSeconds !== undefined) rpcArgs.periodSeconds = periodSeconds;
    ...
    /** Adds an HTTP health probe to the resource */
    withHttpProbe(probeType: ProbeType, options?: WithHttpProbeOptions): GolangAppExecutableResourcePromise {
        const path = options?.path;
        const initialDelaySeconds = options?.initialDelaySeconds;
        const periodSeconds = options?.periodSeconds;
        const timeoutSeconds = options?.timeoutSeconds;
        ...
        const successThreshold = options?.successThreshold;
        const endpointName = options?.endpointName;
        return new GolangAppExecutableResourcePromise(this._withHttpProbeInternal(probeType, path, initialDelaySeconds, periodSeconds, timeoutSeconds, failureThreshold, successThreshold, endpointName));
    }

    /** @internal */
    private async _excludeFromMcpInternal(): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/excludeFromMcp',
            rpcArgs
    ...
    /** Excludes the resource from MCP server exposure */
    excludeFromMcp(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._excludeFromMcpInternal());
    }

    /** @internal */
    private async _withRemoteImageNameInternal(remoteImageName: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, remoteImageName };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withRemoteImageName',
            rpcArgs
    ...
    /** Sets the remote image name for publishing */
    withRemoteImageName(remoteImageName: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withRemoteImageNameInternal(remoteImageName));
    }

    /** @internal */
    private async _withRemoteImageTagInternal(remoteImageTag: string): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, remoteImageTag };
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'Aspire.Hosting/withRemoteImageTag',
            rpcArgs
    ...
    /** Sets the remote image tag for publishing */
    withRemoteImageTag(remoteImageTag: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withRemoteImageTagInternal(remoteImageTag));
    }

    /** @internal */
    private async _withPipelineStepFactoryInternal(stepName: string, callback: (arg: PipelineStepContext) => Promise<void>, dependsOn?: string[], requiredBy?: string[], tags?: string[], description?: string): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as PipelineStepContextHandle;
            const arg = new PipelineStepContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Adds a pipeline step to the resource */
    withPipelineStepFactory(stepName: string, callback: (arg: PipelineStepContext) => Promise<void>, options?: WithPipelineStepFactoryOptions): GolangAppExecutableResourcePromise {
        const dependsOn = options?.dependsOn;
        const requiredBy = options?.requiredBy;
        const tags = options?.tags;
        const description = options?.description;
        return new GolangAppExecutableResourcePromise(this._withPipelineStepFactoryInternal(stepName, callback, dependsOn, requiredBy, tags, description));
    }

    /** @internal */
    private async _withPipelineConfigurationAsyncInternal(callback: (arg: PipelineConfigurationContext) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as PipelineConfigurationContextHandle;
            const arg = new PipelineConfigurationContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Configures pipeline step dependencies via an async callback */
    withPipelineConfigurationAsync(callback: (arg: PipelineConfigurationContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withPipelineConfigurationAsyncInternal(callback));
    }

    /** @internal */
    private async _withPipelineConfigurationInternal(callback: (obj: PipelineConfigurationContext) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as PipelineConfigurationContextHandle;
            const obj = new PipelineConfigurationContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Configures pipeline step dependencies via a callback */
    withPipelineConfiguration(callback: (obj: PipelineConfigurationContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._withPipelineConfigurationInternal(callback));
    }
    ...
    /** @internal */
    private async _onBeforeResourceStartedInternal(callback: (arg: BeforeResourceStartedEvent) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as BeforeResourceStartedEventHandle;
            const arg = new BeforeResourceStartedEvent(argHandle, this._client);
            await callback(arg);
    ...
    /** Subscribes to the BeforeResourceStarted event */
    onBeforeResourceStarted(callback: (arg: BeforeResourceStartedEvent) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._onBeforeResourceStartedInternal(callback));
    }

    /** @internal */
    private async _onResourceStoppedInternal(callback: (arg: ResourceStoppedEvent) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceStoppedEventHandle;
            const arg = new ResourceStoppedEvent(argHandle, this._client);
            await callback(arg);
    ...
    /** Subscribes to the ResourceStopped event */
    onResourceStopped(callback: (arg: ResourceStoppedEvent) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._onResourceStoppedInternal(callback));
    }

    /** @internal */
    private async _onInitializeResourceInternal(callback: (arg: InitializeResourceEvent) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as InitializeResourceEventHandle;
            const arg = new InitializeResourceEvent(argHandle, this._client);
            await callback(arg);
    ...
    /** Subscribes to the InitializeResource event */
    onInitializeResource(callback: (arg: InitializeResourceEvent) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._onInitializeResourceInternal(callback));
    }

    /** @internal */
    private async _onResourceEndpointsAllocatedInternal(callback: (arg: ResourceEndpointsAllocatedEvent) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceEndpointsAllocatedEventHandle;
            const arg = new ResourceEndpointsAllocatedEvent(argHandle, this._client);
            await callback(arg);
    ...
    /** Subscribes to the ResourceEndpointsAllocated event */
    onResourceEndpointsAllocated(callback: (arg: ResourceEndpointsAllocatedEvent) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._onResourceEndpointsAllocatedInternal(callback));
    }

    /** @internal */
    private async _onResourceReadyInternal(callback: (arg: ResourceReadyEvent) => Promise<void>): Promise<GolangAppExecutableResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceReadyEventHandle;
            const arg = new ResourceReadyEvent(argHandle, this._client);
            await callback(arg);
    ...
    /** Subscribes to the ResourceReady event */
    onResourceReady(callback: (arg: ResourceReadyEvent) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._onResourceReadyInternal(callback));
    }

    /** @internal */
    private async _withGoModTidyInternal(install?: boolean): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (install !== undefined) rpcArgs.install = install;
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'CommunityToolkit.Aspire.Hosting.Golang/withGoModTidyPolyglot',
            rpcArgs
        );
        return new GolangAppExecutableResource(result, this._client);
    }

    /** Runs go mod tidy before the application starts */
    withGoModTidy(options?: WithGoModTidyOptions): GolangAppExecutableResourcePromise {
        const install = options?.install;
        return new GolangAppExecutableResourcePromise(this._withGoModTidyInternal(install));
    }

    /** @internal */
    private async _withGoModDownloadInternal(install?: boolean): Promise<GolangAppExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (install !== undefined) rpcArgs.install = install;
        const result = await this._client.invokeCapability<GolangAppExecutableResourceHandle>(
            'CommunityToolkit.Aspire.Hosting.Golang/withGoModDownloadPolyglot',
            rpcArgs
        );
        return new GolangAppExecutableResource(result, this._client);
    }

    /** Runs go mod download before the application starts */
    withGoModDownload(options?: WithGoModDownloadOptions): GolangAppExecutableResourcePromise {
        const install = options?.install;
        return new GolangAppExecutableResourcePromise(this._withGoModDownloadInternal(install));
    }

}

/**
 * Thenable wrapper for GolangAppExecutableResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class GolangAppExecutableResourcePromise implements PromiseLike<GolangAppExecutableResource> {
    constructor(private _promise: Promise<GolangAppExecutableResource>) {}

    then<TResult1 = GolangAppExecutableResource, TResult2 = never>(
        onfulfilled?: ((value: GolangAppExecutableResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Configures a resource to use a container registry */
    withContainerRegistry(registry: ResourceBuilderBase): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withContainerRegistry(registry)));
    }

    /** Sets the base image for a Dockerfile build */
    withDockerfileBaseImage(options?: WithDockerfileBaseImageOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withDockerfileBaseImage(options)));
    }

    /** Publishes the executable as a Docker container */
    publishAsDockerFile(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.publishAsDockerFile()));
    }

    /** Publishes an executable as a Docker file with optional container configuration */
    publishAsDockerFileWithConfigure(configure: (obj: ContainerResource) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.publishAsDockerFileWithConfigure(configure)));
    }

    /** Sets the executable command */
    withExecutableCommand(command: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withExecutableCommand(command)));
    }

    /** Sets the executable working directory */
    withWorkingDirectory(workingDirectory: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withWorkingDirectory(workingDirectory)));
    }

    /** Configures an MCP server endpoint on the resource */
    withMcpServer(options?: WithMcpServerOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withMcpServer(options)));
    }

    /** Configures OTLP telemetry export */
    withOtlpExporter(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withOtlpExporter()));
    }

    /** Configures OTLP telemetry export with specific protocol */
    withOtlpExporterProtocol(protocol: OtlpProtocol): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withOtlpExporterProtocol(protocol)));
    }

    /** Adds a required command dependency */
    withRequiredCommand(command: string, options?: WithRequiredCommandOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withRequiredCommand(command, options)));
    }

    /** Sets environment variables via callback */
    withEnvironmentCallback(callback: (arg: EnvironmentCallbackContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withEnvironmentCallback(callback)));
    }

    /** Sets an environment variable from an endpoint reference */
    withEnvironmentEndpoint(name: string, endpointReference: EndpointReference): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withEnvironmentEndpoint(name, endpointReference)));
    }

    /** Sets an environment variable on the resource */
    withEnvironment(name: string, value: string | ReferenceExpression | EndpointReference | ParameterResource | ResourceWithConnectionString): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withEnvironment(name, value)));
    }

    /** Sets an environment variable from a parameter resource */
    withEnvironmentParameter(name: string, parameter: ParameterResource): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withEnvironmentParameter(name, parameter)));
    }

    /** Sets an environment variable from a connection string resource */
    withEnvironmentConnectionString(envVarName: string, resource: ResourceBuilderBase): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withEnvironmentConnectionString(envVarName, resource)));
    }

    /** Adds arguments */
    withArgs(args: string[]): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withArgs(args)));
    }

    /** Sets command-line arguments via callback */
    withArgsCallback(callback: (obj: CommandLineArgsCallbackContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withArgsCallback(callback)));
    }

    /** Sets command-line arguments via async callback */
    withArgsCallbackAsync(callback: (arg: CommandLineArgsCallbackContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withArgsCallbackAsync(callback)));
    }

    /** Adds a reference to another resource */
    withReference(source: ResourceBuilderBase, options?: WithReferenceOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withReference(source, options)));
    }

    /** Adds a reference to a URI */
    withReferenceUri(name: string, uri: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withReferenceUri(name, uri)));
    }

    /** Adds a reference to an external service */
    withReferenceExternalService(externalService: ExternalServiceResource): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withReferenceExternalService(externalService)));
    }

    /** Adds a reference to an endpoint */
    withReferenceEndpoint(endpointReference: EndpointReference): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withReferenceEndpoint(endpointReference)));
    }

    /** Adds a network endpoint */
    withEndpoint(options?: WithEndpointOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withEndpoint(options)));
    }

    /** Adds an HTTP endpoint */
    withHttpEndpoint(options?: WithHttpEndpointOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withHttpEndpoint(options)));
    }

    /** Adds an HTTPS endpoint */
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withHttpsEndpoint(options)));
    }

    /** Makes HTTP endpoints externally accessible */
    withExternalHttpEndpoints(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withExternalHttpEndpoints()));
    }
    ...
    /** Configures resource for HTTP/2 */
    asHttp2Service(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.asHttp2Service()));
    }

    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Adds a URL for a specific endpoint via factory callback */
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withUrlForEndpointFactory(endpointName, callback)));
    }

    /** Configures the resource to copy container files from the specified source during publishing */
    publishWithContainerFiles(source: ResourceBuilderBase, destinationPath: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.publishWithContainerFiles(source, destinationPath)));
    }

    /** Excludes the resource from the deployment manifest */
    excludeFromManifest(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.excludeFromManifest()));
    }

    /** Waits for another resource to be ready */
    waitFor(dependency: ResourceBuilderBase): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.waitFor(dependency)));
    }

    /** Waits for another resource with specific behavior */
    waitForWithBehavior(dependency: ResourceBuilderBase, waitBehavior: WaitBehavior): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.waitForWithBehavior(dependency, waitBehavior)));
    }

    /** Waits for another resource to start */
    waitForStart(dependency: ResourceBuilderBase): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.waitForStart(dependency)));
    }

    /** Waits for another resource to start with specific behavior */
    waitForStartWithBehavior(dependency: ResourceBuilderBase, waitBehavior: WaitBehavior): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.waitForStartWithBehavior(dependency, waitBehavior)));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Waits for resource completion */
    waitForCompletion(dependency: ResourceBuilderBase, options?: WaitForCompletionOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.waitForCompletion(dependency, options)));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds an HTTP health check */
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withHttpHealthCheck(options)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Configures developer certificate trust */
    withDeveloperCertificateTrust(trust: boolean): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withDeveloperCertificateTrust(trust)));
    }

    /** Sets the certificate trust scope */
    withCertificateTrustScope(scope: CertificateTrustScope): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withCertificateTrustScope(scope)));
    }

    /** Configures HTTPS with a developer certificate */
    withHttpsDeveloperCertificate(options?: WithHttpsDeveloperCertificateOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withHttpsDeveloperCertificate(options)));
    }

    /** Removes HTTPS certificate configuration */
    withoutHttpsCertificate(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withoutHttpsCertificate()));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }

    /** Sets a child relationship */
    withChildRelationship(child: ResourceBuilderBase): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withChildRelationship(child)));
    }

    /** Sets the icon for the resource */
    withIconName(iconName: string, options?: WithIconNameOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withIconName(iconName, options)));
    }

    /** Adds an HTTP health probe to the resource */
    withHttpProbe(probeType: ProbeType, options?: WithHttpProbeOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withHttpProbe(probeType, options)));
    }

    /** Excludes the resource from MCP server exposure */
    excludeFromMcp(): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.excludeFromMcp()));
    }

    /** Sets the remote image name for publishing */
    withRemoteImageName(remoteImageName: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withRemoteImageName(remoteImageName)));
    }

    /** Sets the remote image tag for publishing */
    withRemoteImageTag(remoteImageTag: string): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withRemoteImageTag(remoteImageTag)));
    }

    /** Adds a pipeline step to the resource */
    withPipelineStepFactory(stepName: string, callback: (arg: PipelineStepContext) => Promise<void>, options?: WithPipelineStepFactoryOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withPipelineStepFactory(stepName, callback, options)));
    }

    /** Configures pipeline step dependencies via an async callback */
    withPipelineConfigurationAsync(callback: (arg: PipelineConfigurationContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withPipelineConfigurationAsync(callback)));
    }

    /** Configures pipeline step dependencies via a callback */
    withPipelineConfiguration(callback: (obj: PipelineConfigurationContext) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withPipelineConfiguration(callback)));
    }
    ...
    /** Subscribes to the BeforeResourceStarted event */
    onBeforeResourceStarted(callback: (arg: BeforeResourceStartedEvent) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.onBeforeResourceStarted(callback)));
    }

    /** Subscribes to the ResourceStopped event */
    onResourceStopped(callback: (arg: ResourceStoppedEvent) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.onResourceStopped(callback)));
    }

    /** Subscribes to the InitializeResource event */
    onInitializeResource(callback: (arg: InitializeResourceEvent) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.onInitializeResource(callback)));
    }

    /** Subscribes to the ResourceEndpointsAllocated event */
    onResourceEndpointsAllocated(callback: (arg: ResourceEndpointsAllocatedEvent) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.onResourceEndpointsAllocated(callback)));
    }

    /** Subscribes to the ResourceReady event */
    onResourceReady(callback: (arg: ResourceReadyEvent) => Promise<void>): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.onResourceReady(callback)));
    }

    /** Runs go mod tidy before the application starts */
    withGoModTidy(options?: WithGoModTidyOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withGoModTidy(options)));
    }

    /** Runs go mod download before the application starts */
    withGoModDownload(options?: WithGoModDownloadOptions): GolangAppExecutableResourcePromise {
        return new GolangAppExecutableResourcePromise(this._promise.then(obj => obj.withGoModDownload(options)));
    }
...
registerHandleWrapper('CommunityToolkit.Aspire.Hosting.Golang/Aspire.Hosting.ApplicationModel.GolangAppExecutableResource', (handle, client) => new GolangAppExecutableResource(handle as GolangAppExecutableResourceHandle, client));
