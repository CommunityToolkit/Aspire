...
| - **Learn More**: [`Hosting.LlamaCpp`][llamacpp-integration-docs] <br /> - Stable 📦: [![CommunityToolkit.Aspire.Hosting.LlamaCpp][llamacpp-shields]][llamacpp-nuget] <br /> - Preview 📦: [![CommunityToolkit.Aspire.Hosting.LlamaCpp][llamacpp-shields-preview]][llamacpp-nuget-preview]                                                                                                                   | An Aspire hosting integration leveraging the [LlamaCpp](https://github.com/ggml-org/llama.cpp) containers.                                        |
...
[llamacpp-integration-docs]: TBD
[llamacpp-shields]: TBD
[llamacpp-nuget]: TBD
[llamacpp-shields-preview]: TBD
[llamacpp-nuget-preview]: TBD