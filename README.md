...
| - **Learn More**: [`Hosting.Jellyfin`][jellyfin-integration-docs] <br /> - Preview 📦: [![CommunityToolkit.Aspire.Hosting.Jellyfin][jellyfin-shields-preview]][jellyfin-nuget-preview]                                                                                                                                                                                                       | An Aspire hosting integration leveraging the [Jellyfin](https://jellyfin.org) media server container.                                                                       |
...
[jellyfin-integration-docs]: https://github.com/CommunityToolkit/Aspire/tree/main/src/CommunityToolkit.Aspire.Hosting.Jellyfin
[jellyfin-shields-preview]: https://img.shields.io/nuget/vpre/CommunityToolkit.Aspire.Hosting.Jellyfin?label=nuget%20(preview)
[jellyfin-nuget-preview]: https://nuget.org/packages/CommunityToolkit.Aspire.Hosting.Jellyfin/absoluteLatest
