...
| - **Learn More**: [`Hosting.Supabase`][supabase-integration-docs] <br /> - Stable 📦: [![CommunityToolkit.Aspire.Hosting.Supabase][supabase-shields]][supabase-nuget] <br /> - Preview 📦: [![CommunityToolkit.Aspire.Hosting.Supabase][supabase-shields-preview]][supabase-nuget-preview]                                                                                                   | A complete [Supabase](https://supabase.com/) stack integration for local development with PostgreSQL, Auth, REST API, Storage, and Studio Dashboard.                       |
