...
/// <summary>Represents the CreateTemplateResponseDataActiveVersion payload.</summary>
public class CreateTemplateResponseDataActiveVersion
{
    ...
    public IReadOnlyList<CreateTemplateResponseDataActiveVersionLocalizationsItem>? Localizations { get; set; }
    ...
    public CreateTemplateResponseDataActiveVersionStylesheet? Stylesheet { get; set; }
