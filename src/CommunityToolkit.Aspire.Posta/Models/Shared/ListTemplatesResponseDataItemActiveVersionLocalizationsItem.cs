...
/// <summary>Represents the ListTemplatesResponseDataItemActiveVersionLocalizationsItem payload.</summary>
public class ListTemplatesResponseDataItemActiveVersionLocalizationsItem
{
