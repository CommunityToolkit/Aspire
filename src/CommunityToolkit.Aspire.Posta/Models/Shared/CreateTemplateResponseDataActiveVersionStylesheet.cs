...
/// <summary>Represents the CreateTemplateResponseDataActiveVersionStylesheet payload.</summary>
public class CreateTemplateResponseDataActiveVersionStylesheet
{
