...
/// <summary>Represents the ListTemplatesResponseDataItemActiveVersion payload.</summary>
public class ListTemplatesResponseDataItemActiveVersion
{
    ...
    public IReadOnlyList<ListTemplatesResponseDataItemActiveVersionLocalizationsItem>? Localizations { get; set; }
    ...
    public ListTemplatesResponseDataItemActiveVersionStylesheet? Stylesheet { get; set; }
