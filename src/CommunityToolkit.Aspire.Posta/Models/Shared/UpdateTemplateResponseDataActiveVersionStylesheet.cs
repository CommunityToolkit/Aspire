...
/// <summary>Represents the UpdateTemplateResponseDataActiveVersionStylesheet payload.</summary>
public class UpdateTemplateResponseDataActiveVersionStylesheet
{
