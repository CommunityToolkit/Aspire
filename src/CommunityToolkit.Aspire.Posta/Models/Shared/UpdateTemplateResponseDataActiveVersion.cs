...
/// <summary>Represents the UpdateTemplateResponseDataActiveVersion payload.</summary>
public class UpdateTemplateResponseDataActiveVersion
{
    ...
    public IReadOnlyList<UpdateTemplateResponseDataActiveVersionLocalizationsItem>? Localizations { get; set; }
    ...
    public UpdateTemplateResponseDataActiveVersionStylesheet? Stylesheet { get; set; }
