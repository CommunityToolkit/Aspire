...
/// <summary>Represents the CreateTemplateResponseDataActiveVersionLocalizationsItem payload.</summary>
public class CreateTemplateResponseDataActiveVersionLocalizationsItem
{
