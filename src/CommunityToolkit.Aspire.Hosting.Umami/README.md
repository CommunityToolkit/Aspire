...
Provides extension methods and resource definitions for the .NET Aspire AppHost to support running [Umami](https://umami.is/) containers.

## Getting started

### Install the package

In your AppHost project, install the .NET Aspire Umami Hosting library with [NuGet](https://www.nuget.org):
