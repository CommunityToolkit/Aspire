...
public class AzureDaprComponentResource(string bicepIdentifier,
    Action<AzureResourceInfrastructure> configureInfrastructure) : AzureProvisioningResource(bicepIdentifier, configureInfrastructure);