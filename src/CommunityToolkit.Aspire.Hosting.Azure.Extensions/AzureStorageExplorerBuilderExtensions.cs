...
public static class AzureStorageExplorerBuilderExtensions
{
    ...
    /// </example>
    /// </remarks>
    public static IResourceBuilder<AzureStorageExplorerResource> AddAzureStorageExplorer(
    ...
    /// <returns>A reference to the <see cref="IResourceBuilder{T}"/>.</returns>
    public static IResourceBuilder<AzureStorageExplorerResource> WithAzurite(
    ...
    /// <summary>
    /// Adds connection to a Blob storage resource.
    /// </summary>
    /// <param name="builder">The builder for the <see cref="AzureStorageExplorerResource"/>.</param>
    /// <param name="blobs">The builder for the linked <see cref="AzureBlobStorageResource"/>.</param>
    /// <returns>A reference to the <see cref="IResourceBuilder{T}"/>.</returns>
    public static IResourceBuilder<AzureStorageExplorerResource> WithBlobs(
        this IResourceBuilder<AzureStorageExplorerResource> builder,
        IResourceBuilder<AzureBlobStorageResource> blobs
    )
    {
        return WithStorageResource(builder, blobs);
    }
    
    /// <summary>
    /// Adds connection to a Queue storage resource.
    /// </summary>
    /// <param name="builder">The builder for the <see cref="AzureStorageExplorerResource"/>.</param>
    /// <param name="queues">The builder for the linked <see cref="AzureQueueStorageResource"/>.</param>
    /// <returns>A reference to the <see cref="IResourceBuilder{T}"/>.</returns>
    public static IResourceBuilder<AzureStorageExplorerResource> WithQueues(
        this IResourceBuilder<AzureStorageExplorerResource> builder,
        IResourceBuilder<AzureQueueStorageResource> queues
    )
    {
        return WithStorageResource(builder, queues);
    }
    
    /// <summary>
    /// Adds connection to a Table storage resource.
    /// </summary>
    /// <param name="builder">The builder for the <see cref="AzureStorageExplorerResource"/>.</param>
    /// <param name="tables">The builder for the linked <see cref="AzureTableStorageResource"/>.</param>
    /// <returns>A reference to the <see cref="IResourceBuilder{T}"/>.</returns>
    public static IResourceBuilder<AzureStorageExplorerResource> WithTables(
        this IResourceBuilder<AzureStorageExplorerResource> builder,
        IResourceBuilder<AzureTableStorageResource> tables
    )
    {
        return WithStorageResource(builder, tables);
    }

    private static IResourceBuilder<AzureStorageExplorerResource> WithStorageResource(
        IResourceBuilder<AzureStorageExplorerResource> builder, 
