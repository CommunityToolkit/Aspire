...
public static class SolrBuilderExtensions
{
    ...
    /// <ats-summary>Mounts a Solr config set directory</ats-summary>
    [AspireExport]
    ...
    /// <ats-summary>Adds a named volume for the Solr data folder</ats-summary>
    [AspireExport]
    ...
    /// <returns>The <see cref="IResourceBuilder{T}"/>.</returns>
    /// <ats-summary>Adds a bind mount for the Solr data folder</ats-summary>
    [AspireExport]
