...
public static class IDistributedApplicationResourceBuilderExtensions
{
    ...
    {
        return builder.WithDaprSidecar(static _ => { });
    }
    ...
    /// <returns>The resource builder instance.</returns>
    public static IResourceBuilder<T> WithDaprSidecar<T>(this IResourceBuilder<T> builder, DaprSidecarOptions options) where T : IResource
    {
        return builder.WithDaprSidecar(sidecarBuilder => sidecarBuilder.WithOptions(options));
    }
    ...
    /// <returns>The resource builder instance.</returns>
    public static IResourceBuilder<T> WithDaprSidecar<T>(this IResourceBuilder<T> builder, Action<IResourceBuilder<DaprSidecarResource>> configureSidecar) where T : IResource
    {
    ...
    public static IResourceBuilder<DaprSidecarResource> WithOptions(this IResourceBuilder<DaprSidecarResource> builder, DaprSidecarOptions options)
    {
    ...
    public static IResourceBuilder<TDestination> WithReference<TDestination>(this IResourceBuilder<TDestination> builder, IResourceBuilder<DaprComponentResource> component) where TDestination : IResource
    {
